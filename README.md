...
SCP Replacer lets eligible non-SCP players volunteer to replace a supported SCP role that becomes available near the beginning of a round. This is a **LabAPI-only** port

> The plugin supports **vanilla SCP roles only**. 
